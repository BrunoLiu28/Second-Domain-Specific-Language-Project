...
//	}
	...
	public static final String INVALID_ACTION_SPECIFIER = "invalidActionSpecifier";
	...
	public static final String INVALID_SENSOR_SPECIFIER = "invalidSensorSpecifier";
