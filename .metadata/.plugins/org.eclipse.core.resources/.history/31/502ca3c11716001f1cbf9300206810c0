...
public class SensorImpl extends ConditionalSensorImpl implements Sensor {
	...
	public void setSensorName(String newSensorName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.SENSOR__SENSOR_NAME, oldSensorName, sensorName));
	}
	...
	public void setSensorSpecifier(String newSensorSpecifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.SENSOR__SENSOR_SPECIFIER, oldSensorSpecifier, sensorSpecifier));
	}
