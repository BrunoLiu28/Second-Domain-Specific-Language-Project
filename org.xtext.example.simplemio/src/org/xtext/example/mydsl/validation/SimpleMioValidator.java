...
//	}
	...
	public static final String MISSING_OBSTACLE_SPECIFIER = "missingObstacleSpecifier";
	public static final String MISSING_BUTTON_SPECIFIER = "missingButtonSpecifier";
	public static final String MISSING_LINE_SPECIFIER = "missingLineSpecifier";
	...
	public void check_missing_specifier(Sensor sensor) {
		...
		case "obstacle":
			if (sensor.getSensorSpecifier() == null) {
				error("Sensor 'obstacle' requires a specifier",
						sensor,
						SimplemioModelPackage.eINSTANCE.getSensor_SensorName(),
						MISSING_OBSTACLE_SPECIFIER);
			}
			break;
			
		case "button":
			if (sensor.getSensorSpecifier() == null) {
				error("Sensor 'button' requires a specifier",
						sensor,
						SimplemioModelPackage.eINSTANCE.getSensor_SensorName(),
						MISSING_BUTTON_SPECIFIER);
			}
			break;
			
		case "line":
			if (sensor.getSensorSpecifier() == null) {
				error("Sensor 'line' requires a specifier",
						sensor,
						SimplemioModelPackage.eINSTANCE.getSensor_SensorName(),
						MISSING_LINE_SPECIFIER);
			}
			break;
		}
	}
	...
	public void check_action_from_same_actuator(Event event) {
		...
		boolean hasMoveOrTurnorStop = false;
