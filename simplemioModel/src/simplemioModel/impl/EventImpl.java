...
public class EventImpl extends MinimalEObjectImpl.Container implements Event {
	...
	public NotificationChain basicSetConditionalsensor(ConditionalSensor newConditionalsensor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.EVENT__CONDITIONALSENSOR, oldConditionalsensor, newConditionalsensor);
	...
	public void setConditionalsensor(ConditionalSensor newConditionalsensor) {
		if (newConditionalsensor != conditionalsensor) {
			...
			if (conditionalsensor != null)
				msgs = ((InternalEObject)conditionalsensor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimplemioModelPackage.EVENT__CONDITIONALSENSOR, null, msgs);
			if (newConditionalsensor != null)
				msgs = ((InternalEObject)newConditionalsensor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimplemioModelPackage.EVENT__CONDITIONALSENSOR, null, msgs);
			msgs = basicSetConditionalsensor(newConditionalsensor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.EVENT__CONDITIONALSENSOR, newConditionalsensor, newConditionalsensor));
	}
