 ...
 * </p>
 * <ul>
 *   <li>{@link simplemioModel.impl.ModelImpl#getProgram <em>Program</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	...
	protected EClass eStaticClass() {
		return SimplemioModelPackage.Literals.MODEL;
	}
	...
	public NotificationChain basicSetProgram(Program newProgram, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimplemioModelPackage.MODEL__PROGRAM, oldProgram, newProgram);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newProgram != program) {
			...
			if (program != null)
				msgs = ((InternalEObject) program).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimplemioModelPackage.MODEL__PROGRAM, null, msgs);
			if (newProgram != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.MODEL__PROGRAM, newProgram,
					newProgram));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SimplemioModelPackage.MODEL__PROGRAM:
