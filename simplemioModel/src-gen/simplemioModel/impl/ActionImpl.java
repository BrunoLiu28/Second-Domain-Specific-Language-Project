...
public class ActionImpl extends MinimalEObjectImpl.Container implements Action {
	...
	public void setStrength(Integer newStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.ACTION__STRENGTH, oldStrength,
					strength));
	}
	...
	public void setActionName(String newActionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.ACTION__ACTION_NAME,
	...
	public void setActionSpecifier(String newActionSpecifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.ACTION__ACTION_SPECIFIER,
					oldActionSpecifier, actionSpecifier));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case SimplemioModelPackage.ACTION__ACTION_SPECIFIER:
			return ACTION_SPECIFIER_EDEFAULT == null ? actionSpecifier != null
					: !ACTION_SPECIFIER_EDEFAULT.equals(actionSpecifier);
		}
