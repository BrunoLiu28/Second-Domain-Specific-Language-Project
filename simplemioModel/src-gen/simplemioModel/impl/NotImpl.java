	...
	public NotificationChain basicSetConditionalsensor(ConditionalSensor newConditionalsensor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimplemioModelPackage.NOT__CONDITIONALSENSOR, oldConditionalsensor, newConditionalsensor);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newConditionalsensor != conditionalsensor) {
			...
			if (conditionalsensor != null)
				msgs = ((InternalEObject) conditionalsensor).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimplemioModelPackage.NOT__CONDITIONALSENSOR, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SimplemioModelPackage.NOT__CONDITIONALSENSOR,
