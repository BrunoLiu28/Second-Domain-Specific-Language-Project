...
public class OrImpl extends ConditionalSensorImpl implements Or {
	...
	public NotificationChain basicSetLeft(ConditionalSensor newLeft, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimplemioModelPackage.OR__LEFT, oldLeft, newLeft);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newLeft != left) {
			...
			if (left != null)
				msgs = ((InternalEObject) left).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimplemioModelPackage.OR__LEFT, null, msgs);
			if (newLeft != null)
	...
	public NotificationChain basicSetRight(ConditionalSensor newRight, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SimplemioModelPackage.OR__RIGHT, oldRight, newRight);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newRight != right) {
			...
			if (right != null)
				msgs = ((InternalEObject) right).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SimplemioModelPackage.OR__RIGHT, null, msgs);
			if (newRight != null)
