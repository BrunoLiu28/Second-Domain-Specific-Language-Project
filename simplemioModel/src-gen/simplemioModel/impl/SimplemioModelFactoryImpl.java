...
public class SimplemioModelFactoryImpl extends EFactoryImpl implements SimplemioModelFactory {
	...
	public static SimplemioModelFactory init() {
		try {
			SimplemioModelFactory theSimplemioModelFactory = (SimplemioModelFactory) EPackage.Registry.INSTANCE
					.getEFactory(SimplemioModelPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		...
		case SimplemioModelPackage.CONDITIONAL_SENSOR:
			return createConditionalSensor();
		default:
